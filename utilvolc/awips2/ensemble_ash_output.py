...
def example2(tdir):
    # Use Files generated by Binyu on SDM run.
    # number of levels is different and causing errors.
    inp = {}
    ...
    inp["latitude"] = 48.1  # latitude of vent.
    inp["longitude"] = -180.00  # longitude of vent
    ...
    tdir = tdir  # directory to find cdump files in.
    # list of cdump files to use
    cdumplist = ["cdump1.001", "cdump1.002", "cdump1.003", "cdump1.004"]
...
def plot_ash_rel_freq(cxra, inp, flin, meanflin):
    ...
    wep.massload_plot(cxra, enslist, name=meanflin, vlist=vlist)
